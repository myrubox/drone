...
class Simulation:
    ...
    def reset_simulation(self, event=None):
        ...
        self.stop_after_forced_landing = False  # <--- СБРОС ФЛАГА ПРИНУДИТЕЛЬНОЙ ПОСАДКИ
    ...
    def start_mission(self, event=None) -> None:
        ...
        try:
            ...
            # --- ДОБАВЬ ПРЕДСТАРТОВУЮ ПРОВЕРКУ ---
            # Определяем заряд после долёта до конечной точки
            ...
            # Проверка: хватит ли на путь B→A
            ...
            # Проверка: хватит ли хотя бы на одну станцию после B
